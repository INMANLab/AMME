...
patient(pID).phase(1).removeChannels.names = {'8Rd7', '26Rd10', '30Rd1', '20Rd10', '20Rd9', '20Rd8', '28Rd8', '22Rd10', 'DC16', 'DC15', 'DC14', 'DC13', 'DC12', 'DC11', 'DC10', 'DC9', 'DC8', 'DC2', 'DC1', 'DC3', 'DC4', 'DC5', 'DC7', 'DC6', 'OSAT', 'PR', 'Pleth', 'TRIG', 'C128', 'C127', 'C126', 'C125', 'C124', 'C123', 'C122', '32Rd1', '32Rd4', '18Rd8', '2Rd7', '2Rd4'}; % Channels that has to be removed before computing the median for phase = 1 (Day1_Study)
patient(pID).phase(2).removeChannels.names = {'8Rd7', '26Rd10', '30Rd1', '20Rd10', '20Rd9', '20Rd8', '28Rd8', '22Rd10', 'DC16', 'DC15', 'DC14', 'DC13', 'DC12', 'DC11', 'DC10', 'DC9', 'DC8', 'DC2', 'DC1', 'DC3', 'DC4', 'DC5', 'DC7', 'DC6', 'OSAT', 'PR', 'Pleth', 'TRIG', 'C128', 'C127', 'C126', 'C125', 'C124', 'C123', 'C122', '32Rd1', '32Rd4', '18Rd8', '2Rd7', '2Rd4'}; % Channels that has to be removed before computing the median for phase = 2 (Day1_ImmTest)
patient(pID).phase(3).removeChannels.names = {'8Rd7', '32Rd1', 'DC10', 'DC9', 'DC8', 'DC7', 'DC6', 'DC5', 'DC4', 'DC3', 'DC2', 'DC1', 'C128', 'C127', 'C126', 'C125', 'C124', 'C123', 'C122', '2Rd7', '2Rd4', '18Rd8', '26Rd10', '22Rd10', '28Rd8', '30Rd5', '20Rd10', '20Rd9', '20Rd8', '30Rd6'}; % Channels that has to be removed before computing the median for phase = 3 (Day2)
...
patient(pID).phase(2).removeChannels.names = {}; % no imm test for this subject, leave blank
patient(pID).phase(3).removeChannels.names = {'5Ld BF10', '5Ld BF9', '5Ld BF8', '5Ld BF5', '5Ld BF6', '5Ld BF3', '5Ld BF15', '7Ld6', '15Ld7', '19Ld7', '21Ld1', '21Ld4', 'Pleth', 'PR', 'OSAT', 'TRIG', 'DC16', 'DC15', 'DC14', 'DC13', 'DC12', 'DC11', 'DC10', 'DC9', 'DC8', 'DC7', 'DC6', 'DC5', 'DC4', 'DC3', 'C128', 'DC2', 'DC1', '23Ld10', '23Ld9', '23Ld8', 'EKG', '23Ld7', '23Ld5', '5Ld BF2', '9Ld4', '3Ld6', '5Ld BF4', '5Ld BF7', '11Ld6', '1Ld1', '1Ld2', '1Ld9', '3Ld1', '3Ld5', '1Ld10', '1Ld3', '1Ld8'}; % Channels that has to be removed before computing the median for phase = 3 (Day2)
